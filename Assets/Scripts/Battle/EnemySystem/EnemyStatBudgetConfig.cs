...
namespace Battle
{
    ...
    public static class EnemyStatBudgetRuleDefaults
    {
        ...
        {
            CreateLinear(StatType.MaximumHealth, 5f),
            CreateLinear(StatType.PhysicalDamage, 1.5f),
            CreateLinear(StatType.FireDamage, 1.5f),
            CreateLinear(StatType.ColdDamage, 1.5f),
            CreateLinear(StatType.LightningDamage, 1.5f),
            CreateLinear(StatType.LightDamage, 1.5f),
            CreateLinear(StatType.DarknessDamage, 1.5f),
            CreateAllocationLinearCap(StatType.CritChance, 1f, 0.5f),
            ...
            CreateAllocationLinearCap(StatType.BlockChance, 1f, 0.5f),
            CreateAllocationLinearCap(StatType.ElementalResistance, 1f, 0.35f),
            CreateAllocationLinearCap(StatType.FireResistance, 2f, 0.5f),
            CreateAllocationLinearCap(StatType.ColdResistance, 2f, 0.5f),
            CreateAllocationLinearCap(StatType.LightningResistance, 2f, 0.5f),
            ...
            CreateAllocationLinearCap(StatType.IgniteMitigation, 1f, 1f),
            CreateAllocationLinearCap(StatType.ChillDurationReduction, 1f, 1f),
            CreateAllocationLinearCap(StatType.OverchargeAvoidanceChance, 1f, 1f),
            CreateAllocationLinearCap(StatType.BleedMitigation, 1f, 1f),
